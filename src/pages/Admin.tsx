    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="border-b border-border bg-card">
        <div className="container-wide flex gap-0">
          <button
            className={`px-4 py-3 text-sm font-medium border-b-2 transition-colors ${activeTab === 'users' ? 'border-primary text-primary' : 'border-transparent text-muted-foreground hover:text-foreground'}`}
            onClick={() => setActiveTab('users')}
          >
            <Users className="h-4 w-4 inline mr-1.5" />Users
          </button>
          <button
            className={`px-4 py-3 text-sm font-medium border-b-2 transition-colors ${activeTab === 'blog' ? 'border-primary text-primary' : 'border-transparent text-muted-foreground hover:text-foreground'}`}
            onClick={() => setActiveTab('blog')}
          >
            <BookOpen className="h-4 w-4 inline mr-1.5" />Blog
          </button>
        </div>
      </div>
